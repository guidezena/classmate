    ...
    <div class="container mt-5">
        <div class="row main">
            ...
            <div class="col-9 classCol">
                <div class=" p-3" style="text-align: center; widrh: 10px">
                    <h2>Adicionar matérias</h2>
                    <select class="form-select mt-5" aria-label="Default select example">
                        <option selected>Escolha a matéria</option>
                        <option value="1">One</option>
                      </select>
                      <select class="form-select mt-5" aria-label="Default select example">
                        <option selected>Instituição de ensino</option>
                        <option value="1">One</option>
                      </select>
                    <div class="mt-5">
                        <a href="#" class="btn btn-primary button" role="button" aria-pressed="true">Adicionar
                            matéria</a>
                    </div>
                </div>
            </div>
