                ...
                <div class="row p-3">
                    <div class="col-sm-6 mb-3">
                        <div class="card shadow p-1 mb-3 bg-white rounded">
                            <div class="card-body">
                                <p class="card-title"><b>Atividade: Lista de exercicios</b></p>
                                <p class="card-text">Descrição: Realizar lista de 10 questões sobre o tema da aula
                                    5 e desenhar a rota dos objetos em cada um.
                                <p>
                            </div>
                        </div>
                    </div>
